...
//
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/api/**").permitAll()
                .and()
                .authorizeRequests().antMatchers("/charts","/products","/typeProducts","/vendors","/rates","/orders","/banners","/blogs","/employees","/users").hasAnyRole("ADMIN","EMPLOYEE")
                .and()
                .authorizeRequests().antMatchers("/productDeleted","/typeProductsDeleted","/vendorsDeleted","/ratesDeleted","/ordersDeleted","/bannersDeleted","/blogsDeleted","/employeesDelete","/usersDelete").hasAnyRole("ADMIN","EMPLOYEE")
                .and()
